...
export KERNEL_BUILDS_DIR="$KERNELS_DIR/builds"
export KERNEL_OUTPUT_DIR="$KERNELS_DIR/output"
export KERNEL_CONFIGS_DIR="$KERNELS_DIR/configs"
export KERNEL_IMAGES_DIR="$PROJECT_HOME/images"
