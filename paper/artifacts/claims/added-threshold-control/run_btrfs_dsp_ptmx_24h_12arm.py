#!/usr/bin/env python3
"""Prepare or launch the isolated Btrfs/DSP/PTMX 12-arm formal matrix."""
...
ARMS = tuple(
    ...
    for module_index, module in enumerate(("btrfs", "dsp", "ptmx"))
...
def main() -> int:
    ...
    parser.add_argument("--run-prefix", default="20260826-local-btrfs-dsp-ptmx-formal24h-v1")
    parser.add_argument("--duration", type=int, default=86400)
    parser.add_argument(
        "--manager-bin",
        default=str(ROOT / "bin/syz-manager-stall-terminal-1c3300367"),
    )
    parser.add_argument("--http-base-port", type=int, default=57000)
