...
func (mgr *Manager) MachineChecked(features flatrpc.Feature,
	...
	case ModeFuzzing, ModeCorpusTriage, ModeStaticCorpusPrepare:
		...
		fuzzerObj := fuzzer.NewFuzzer(context.Background(), &fuzzer.Config{
			...
			RaceExecOnly:                 mgr.cfg.Experimental.RaceExecOnly,
			...
			RaceCandidateTriageMaxJobs:   mgr.cfg.Experimental.RaceCandidateTriageMaxJobs,
			RaceDisableNormalTriage:      mgr.cfg.Experimental.RaceDisableNormalTriage,
