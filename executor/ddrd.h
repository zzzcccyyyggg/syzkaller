...
typedef struct {
	...
	// Additional context
	uint8_t lock_type;    // Lock type (e.g., mutex, rwlock)
	uint8_t access_type1; // First access type (read/write/free)
	uint8_t access_type2; // Second access type (read/write/free)
