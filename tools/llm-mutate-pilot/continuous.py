...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--variants-per-entry", type=int, default=3)
    ...
    parser.add_argument("--parallel-calls", type=int, default=1, help="number of concurrent LLM calls per round")
